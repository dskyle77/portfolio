...
${message}
    ...
    const whatsappUrl = `https://wa.me/2348161592059?text=${encodeURIComponent(text)}`;
      ...
      <Box sx={{ py: { xs: 10, md: 14 } }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            >
              Got an idea or project? Send me a message and I’ll get back to
              you.
            </Typography>
          </Box>
          ...
          >
            ...
            >
              <Stack spacing={2.2}>
                <Box sx={cardStyle} role="listitem">
                  <Box sx={iconWrap}>
